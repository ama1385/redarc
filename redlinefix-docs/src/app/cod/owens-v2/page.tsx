...
export default function OwensV2() {
  return (
    <DocLayout
      title="اوينز V2"
      titleIcon={
      ...
      description="برنامج اوينز الإصدار الثاني لكول اوف ديوتي"
      breadcrumbs={[
        { label: "دليل الخطوات", href: "/" },
        { label: "قسم كول اوف ديوتي", href: "/cod/progress" },
      ]}
      prevPage={{ title: "فكتورتي", href: "/cod/victory" }}
      nextPage={{ title: "انجن", href: "/cod/engine" }}
    ...
    >
      <section className="mb-12">
        ...
        <p className="text-[#a8a3a4] mb-6">
          الإصدار الثاني من برنامج اوينز مع تحسينات كبيرة في الأداء والمميزات.
        </p>
