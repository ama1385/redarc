...
export default function Victory() {
  return (
    <DocLayout
      ...
      description="برنامج فكتورتي لكول اوف ديوتي"
      breadcrumbs={[
        { label: "دليل الخطوات", href: "/" },
        { label: "قسم كول اوف ديوتي", href: "/cod/progress" },
      ]}
      prevPage={{ title: "بروقرس", href: "/cod/progress" }}
      nextPage={{ title: "اوينز V2", href: "/cod/owens-v2" }}
    ...
    >
      <section className="mb-12">
        ...
        <p className="text-[#a8a3a4] mb-6">
          برنامج فكتورتي هو برنامج متقدم لكول اوف ديوتي يوفر مميزات حصرية وأداء عالي.
        </p>
