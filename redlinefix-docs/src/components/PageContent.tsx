...
import { ChevronLeft, Copy, List } from "lucide-react";

export default function PageContent() {
  return (
    <div className="flex-1 max-w-3xl mx-auto px-6 py-8">
      {/* Breadcrumbs */}
      <div className="flex items-center gap-2 text-sm text-[#746c6d] mb-6">
        <a href="#" className="flex items-center gap-1 hover:text-[#a8a3a4]">
        ...
        <a href="#" className="hover:text-[#a8a3a4]">الأساسيات</a>
      </div>

      {/* Page Actions */}
      <div className="flex items-center gap-2 justify-start mb-6">
        <button className="flex items-center gap-2 px-3 py-1.5 text-sm text-[#746c6d] hover:text-[#a8a3a4] border border-[#333] rounded-lg hover:bg-[#252525] transition-colors">
          <Copy className="w-4 h-4" />
          <span>Copy</span>
        </button>
        <button className="p-1.5 text-[#746c6d] hover:text-[#a8a3a4] border border-[#333] rounded-lg hover:bg-[#252525] transition-colors">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-3xl font-bold text-[#e2dfe0]">تعطيل Secure Boot</h1>
      </div>

      {/* Description */}
      <p className="text-[#a8a3a4] mb-10 leading-relaxed">
        في نظامك عشان تضمن تشغيل Secure Boot هذي الصفحة راح تعلمك كيف تطفّي برنامجنا بشكل سلس.
      </p>
      ...
      <section id="khtwat-tatyl-secure-boot" className="mb-12">
        ...
        <section id="itha-kan-secure-boot-mfa-l-enabled" className="mb-10">
          ...
          {/* Note */}
          <blockquote className="my-6 text-[#a8a3a4] py-2">
        ...
        <section id="khtwat-tatyl-secure-boot-mn-bios" className="mb-10">
          ...
          <ol className="space-y-4 text-[#a8a3a4] list-decimal list-inside mr-4">
            <li className="leading-relaxed">
              ...
              <blockquote className="mt-2 mr-6 py-1 text-sm">
      ...
      {/* Navigation */}
      <div className="grid grid-cols-2 gap-4 mt-12 pt-8 border-t border-[#333]">
        <a
          href="#"
          className="flex items-center gap-3 p-4 bg-[#252525] rounded-xl border border-[#333] hover:border-[#4a4a4a] transition-colors group"
        >
          <ChevronLeft className="w-5 h-5 text-[#746c6d] group-hover:text-[#a8a3a4] rotate-180" />
          <div className="text-right">
            <div className="text-xs text-[#746c6d]">Previous</div>
            <div className="text-sm text-[#e2dfe0]">تمكين Virtualization</div>
          </div>
        </a>
        <a
          href="#"
          className="flex items-center gap-3 p-4 bg-[#252525] rounded-xl border border-[#333] hover:border-[#4a4a4a] transition-colors group justify-end"
        >
          <div className="text-left">
            <div className="text-xs text-[#746c6d]">Next</div>
            <div className="text-sm text-[#e2dfe0]">تفعيل Hyper-V</div>
          </div>
          <ChevronLeft className="w-5 h-5 text-[#746c6d] group-hover:text-[#a8a3a4]" />
        </a>
      </div>

      {/* Last Updated */}
      <p className="text-center text-sm text-[#746c6d] mt-8">
